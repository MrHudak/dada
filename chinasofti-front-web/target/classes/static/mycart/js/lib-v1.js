...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://manager.chinasofti.com/rest/item/cat/all?callback=category.getDataService",
		URL_Serv:"http://manager.chinasofti.com/rest/item/cat/all?callback=category.getDataService",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://localhost:8185" + c + ".html"), '<a href="../../js/' + c + '">' + d + "</a>")
